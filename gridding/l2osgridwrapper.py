	...
	for year in range(year_init, year_fin+1):
		for month in range(month_init, month_fin+1):
			for dn in ['day','night']:
				...
				monthstring += 'python l2osgridding.py {} {} {} {} {} {} {}'.format(year, format(month,'02d'), dn, instrt, version, subversion, filter_val)
				...
				if operands[0] == 'y':
					...
					os.system('python l2osgridding.py {} {} {} {} {} {} {}'.format(year, format(month,'02d'), dn, instrt, version, subversion, filter_val))
